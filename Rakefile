...
ssh_user       = "ubuntu@geridoc.net"
ssh_port       = "22"
document_root  = "/var/www/html"
rsync_delete   = false
rsync_args     = "--omit-dir-times --no-p"  # Any extra arguments to pass to rsyn

# This will be configured for you when you run config_deploy
deploy_branch  = "gh-pages"

## -- S3 Deploy config -- ##
s3_bucket      = "geridoc.net"
...
task :s3sync do
  ...
  ok_failed system("aws s3 cp --content-type 'text/css' --acl public-read s3://geridoc.net/stylesheets/screen.css s3://geridoc.net/stylesheets/screen.css --metadata-directive REPLACE")
end
